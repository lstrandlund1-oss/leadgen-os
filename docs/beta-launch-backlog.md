...
- 🔲 **Homepage messaging rewrite** — restructure from feature-first to Problem → Desired Outcome → Why Vantio → Evidence → Features; outcome-focused copy ("Know who deserves your next hour" instead of "Signal-driven scoring"). Isolated to public marketing pages, doesn't touch the authenticated app
