...
export const en: TranslationSchema = {
  ui: {
    ...
    members: {
      ...
      acceptSuccess: "You're in. Taking you to Vantio…",
      acceptError: "Couldn't accept this invitation",
    },
    templates: {
      title: "Templates",
      createButton: "New template",
      nameLabel: "Name",
      namePlaceholder: "e.g. First outreach — SaaS",
      channelLabel: "Channel",
      subjectLabel: "Subject",
      subjectPlaceholder: "Email subject line",
      bodyLabel: "Message",
      bodyPlaceholder: "Write your template message…",
      toneLabel: "Tone",
      save: "Save template",
      cancel: "Cancel",
      delete: "Delete",
      emptyStateTitle: "No templates yet",
      emptyStateBody: "Save a message you like as a template so you can reuse it for future outreach.",
      loading: "Loading your templates…",
      channelEmail: "Email",
      channelLinkedin: "LinkedIn DM",
      channelCold: "Cold call",
    },
    markets: {
      title: "Markets",
      createButton: "New market",
      createTitle: "Create a market",
      nameLabel: "Name",
      namePlaceholder: "e.g. Web Agencies in Sweden",
      nicheLabel: "Niche",
      nichePlaceholder: "e.g. web agency",
      locationLabel: "Location",
      locationPlaceholder: "e.g. Stockholm",
      save: "Create market",
      cancel: "Cancel",
      emptyStateTitle: "No markets yet",
      emptyStateBody:
        "Save a search as a market to track it over time — new companies, coverage, and opportunity as it changes.",
      totalCompanies: "Total companies",
      highOpportunity: "High opportunity",
      goodOpportunity: "Good opportunity",
      lowOpportunity: "Low opportunity",
      contacted: "Contacted",
      lostNotFit: "Lost / Not a fit",
      newThisMonth: "New this month",
      estimatedCoverage: "Est. market coverage",
      coverageTooltip:
        "Share of this market's searches where Google Places reported no further results — an estimate of how much of what's discoverable has been found, not the true size of the market.",
      refresh: "Refresh",
    ...
    stats: {
      ...
      lostReasonsTitle: "Why deals are being lost",
      lostReasonsEmpty: "No lost deals recorded yet.",
      lostReasonNoResponse: "No response",
      lostReasonNotInterested: "Not interested",
      lostReasonHasProvider: "Has a provider",
      lostReasonWrongTiming: "Wrong timing",
      ...
      activityOverTimeTitle: "Activity over time",
      activityOverTimeEmpty: "Not enough outreach history yet — this fills in over the coming weeks.",
      bestReplyWeekLabel: "Best reply week",
      leadsContactedPerWeek: "Leads contacted per week",
      replyRatePerWeek: "Reply rate % per week",
      closeRateOverTimeTitle: "Close rate over time",
      totalContactedLabel: "Total contacted",
      dealsClosedLabel: "Deals closed",
      overallCloseRateLabel: "Overall close rate",
      closeRatePerWeek: "Close rate % per week",
      performanceThisMonthTitle: "Performance this month",
      contactsMadeMetric: "Contacts made",
      repliesMetric: "Replies",
      meetingsMetric: "Meetings",
      wonMetric: "Won",
      revenueWonMetric: "Revenue won",
      performanceCalendarHint: "Click a metric to see which days it came from",
      noActivityOnDay: "No activity",
    },
    usagePlan: {
      title: "Usage & Plan",
      loading: "Loading…",
      loadError: "Couldn't load usage data. Try refreshing the page.",
      noMembershipTitle: "No active beta membership",
      noMembershipExpired: "Your beta period has ended.",
      noMembershipRevoked: "Your beta access was revoked.",
      noMembershipGeneric: "You don't have an active beta membership.",
      betaStatusLabel: "Beta status",
      activeLabel: "Active",
      activeDaysRemaining: "active days remaining",
      calendarDaysRemaining: "calendar days remaining",
      usageThisPeriodTitle: "Usage this period",
      todayLabel: "Today",
      betaTotalLabel: "Beta total",
      featureOutreach: "Outreach messages",
      featureFollowup: "Follow-up sequences",
      featureAiDeepSearch: "AI deep search",
      discountTitle: "Beta discount",
      discountMessage: (percent: number, months: number) => `${percent}% off for ${months} months`,
      discountEarned: "earned, ready to redeem at launch",
      discountPending: "in progress",
    ...
    home: {
      ...
      insightBody: (message, lift) => `${message} convert ${lift}x better for you.`,
      seeSimilarOpportunities: "See similar opportunities",
      goalTitle: "Your goal this month",
      goalProgress: (current, target) => `${current} / ${target}`,
      goalBasedOn: (months) => `Based on your last ${months} months`,
      ...
      todaysRecapTitle: "Today's Recap",
      contactedToday: "Contacted",
      repliedToday: "Replies",
    ...
    forgotPassword: {
      ...
      sentBodyBeforeEmail: "We've sent a password reset link to ",
      sentBodyAfterEmail: ". It expires in 1 hour.",
    ...
    resetPassword: {
      ...
      doneBody: "Redirecting you to the dashboard…",
      verifyingTitle: "Verifying reset link…",
      verifyingHint: "If this takes too long, your link may have expired.",
