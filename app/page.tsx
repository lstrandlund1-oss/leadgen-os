      ...
      <div class="stage">
        <div id="phase1">
          <div class="search-bar" id="search-bar">
            ...
            <span style="font-size:14px; color:#e0d8c8; display:inline-block; clip-path:inset(0 100% 0 0); animation: heroTypewriter 850ms steps(24, end) 1 forwards;" id="typed-text">web agencies · stockholm</span><span class="cursor" id="cursor"></span>
