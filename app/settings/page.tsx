          ...
          <div className="flex-1 min-w-0 space-y-5">
            ...
            {loading ? (
              ...
              <>
                ...
                {/* ── Danger zone tab ── */}
                {activeTab === "danger" && (
                  <div className="rounded-2xl border border-[#f87171]/20 bg-[#0d0d0d] p-6 space-y-5">
                    <div>
                      <p className="text-[10px] uppercase tracking-[0.15em] text-[#f87171]/60 mb-1">Irreversible actions</p>
                      <h2 className="text-[15px] font-semibold text-[#c8c0b0]">Danger Zone</h2>
                    </div>
                    <div className="rounded-xl border border-[#f87171]/15 bg-[#f87171]/03 px-4 py-4 space-y-3">
                      <div>
                        <p className="text-[13px] text-[#c8c0b0]">Delete account</p>
                        <p className="text-[11px] text-[#555] mt-0.5">Permanently delete your account and all data. This cannot be undone.</p>
                      </div>
                      <Link href="/account/delete"
                        className="inline-block text-[12px] px-4 py-2 rounded-lg border border-[#f87171]/25 text-[#f87171]/70 hover:border-[#f87171]/50 hover:text-[#f87171] transition-all">
                        Delete my account →
                      </Link>
                    </div>
                    <div className="rounded-xl border border-[#252525] bg-[#080808] px-4 py-4 space-y-3">
                      <div>
                        <p className="text-[13px] text-[#c8c0b0]">Clear all saved data</p>
                        <p className="text-[11px] text-[#555] mt-0.5">Reset notes, saved leads, and local preferences stored in this browser.</p>
                      </div>
                      <button type="button"
                        onClick={() => {
