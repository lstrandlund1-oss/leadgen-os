                      ...
                      <div className="space-y-5">
                        ...
                        <div>
                          ...
                          <p className="text-[11px] text-[#444] mb-3">
                            Your preferred size is shown first in results. Other sizes still appear below.
                          </p>
                    ...
                    <div className={sectionClass}>
                      ...
                      <div className="space-y-3">
                        <p className="text-[12px] text-[#555]">
                          Reset notes, saved leads, and local preferences stored in this browser only. Your Supabase
                          data is unaffected.
                        </p>
                        {!clearConfirm ? (
                          <button
                    ...
                    <div className="rounded-2xl border border-[#f87171]/15 bg-[#0d0d0d] p-5 space-y-4">
                      <div>
                        ...
                        <p className="text-[11px] text-[#555] mt-1 leading-relaxed">
                          Permanently deletes your profile, searches, and login credentials. No refund will be issued
                        ...
                        <div className="rounded-xl border border-[#f87171]/20 bg-[#f87171]/04 p-4 space-y-4">
                          <div className="space-y-2">
                            ...
                            <p className="text-[12px] text-[#888] leading-relaxed">
                              This will permanently erase your account. There is no recovery option.
                            </p>
                            <p className="text-[11px] text-[#555] leading-relaxed">
                              Your subscription benefits will remain active until the end of your current billing period
                              even after deletion.
                            </p>
                          </div>
                          <div className="flex gap-2">
                      ...
                      {deleteStep === 2 && (
                        <div className="rounded-xl border border-[#f87171]/20 bg-[#f87171]/04 p-4 space-y-4">
                          <p className="text-[12px] text-[#888]">
                            Type <span className="font-mono text-[#f87171] font-bold">DELETE</span> to confirm.
                          </p>
                          <input
                            type="text"
                            value={deleteConfirm}
                        ...
                        <div className="flex items-center justify-between rounded-xl border border-[#1a1a1a] bg-[#080808] px-4 py-3.5">
                          <div>
                            ...
                            <p className="text-[11px] text-[#444] mt-0.5">
                              {theme === "dark"
                                ? "Easy on the eyes, matches the brand"
                                : "White and gold — high contrast"}
                            </p>
                          </div>
                          <button
                            type="button"
                            ...
                            <span
                              className={
                                "absolute h-3.5 w-3.5 rounded-full transition-transform " +
                                (theme === "light" ? "translate-x-[18px] bg-[#b8942e]" : "translate-x-[3px] bg-[#333]")
                              }
                            />
                          </button>
                        </div>
                    ...
                    <div className={sectionClass}>
                      <div>
                        ...
                        <p className="text-[12px] text-[#444] mt-1">
                          Control which notifications appear in the bell menu
                        </p>
                      </div>
                      <div className="space-y-3">
                        {[
                          ...
                          },
                          {
                            ...
                            sub: "Summary of your activity every Monday — includes a link to download your weekly stats",
                    ...
                    <div className={sectionClass}>
                      ...
                      <div className="flex items-center justify-between gap-4 rounded-xl border border-[#1a1a1a] bg-[#080808] px-4 py-3.5">
                        <div>
                          ...
                          <p className="text-[11px] text-[#444] mt-0.5">
                            Receive enabled notifications at {userEmail || "your email"}
                          </p>
                        </div>
                        <button
                          type="button"
                          ...
                          className={
                            "relative inline-flex h-5 w-9 items-center rounded-full border transition-colors cursor-pointer " +
                            (notifyEmail ? "bg-[rgba(201,168,76,0.2)] border-[#c9a84c]" : "bg-[#111] border-[#252525]")
                          }>
                          <span
                            className={
                              "absolute h-3.5 w-3.5 rounded-full transition-transform " +
                    ...
                    {betaStatus.active ? (
                      <div className={sectionClass}>
                        <div>
                          ...
                          <h2 className="text-[15px] font-semibold text-[#c8c0b0]">You&apos;re a beta tester</h2>
                        </div>
                        <div className="rounded-xl border border-[#1a1a1a] bg-[#080808] px-4 py-4 space-y-1">
                          <p className="text-[13px] text-[#c8c0b0] font-medium">
                            Full platform access — free, no card needed
                          </p>
                          <p className="text-[11px] text-[#444] mt-0.5">
                            {betaStatus.daysRemainingActive} active day{betaStatus.daysRemainingActive === 1 ? "" : "s"}{" "}
                            remaining
                          </p>
                        </div>
                      </div>
                        ...
                        <div className="rounded-xl border border-[#1a1a1a] bg-[#080808] px-4 py-4 space-y-3">
                          ...
                          <div className="pt-2 border-t border-[#141414]">
                            <p className="text-[11px] text-[#444] leading-relaxed">
                              If you downgrade your plan, your current plan&apos;s benefits remain active until the end
