            ...
            <div className="space-y-3">
              ...
              <div className="rounded-2xl border border-[#252525] bg-[#0d0d0d] p-4 space-y-3">
                ...
                <input
                  ...
                  placeholder={
                    leadsLoading
                      ? t.loadingLeads
                      : t.searchLeadsPlaceholder.replace("{count}", String(savedLeads.length))
                  }
              ...
              <div className="rounded-2xl border border-[#252525] bg-[#0d0d0d] p-4 space-y-2.5">
                ...
                <div className="grid grid-cols-2 gap-1.5">
                  {(Object.entries(TONE_META) as [OutreachTone, (typeof TONE_META)[OutreachTone]][]).map(
                    ([tn, meta]) => (
                      <button
                        key={tn}
                        type="button"
                        ...
                        <div className="rounded-xl border border-[#1e1e1e] bg-[#0a0a0a] p-4 space-y-3">
                          ...
                          {templates.length > 0 && (
                            <div className="space-y-1.5 pt-2 border-t border-[#141414]">
                              <p className="text-[9px] uppercase tracking-widests text-[#333]">
